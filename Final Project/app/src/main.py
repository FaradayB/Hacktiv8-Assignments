...
from monitoring import record_track1_query, record_track2_query, start_metrics_server
...
async def lifespan(app: FastAPI):
    ...
    log.info("Starting MitsuCare API ...")
    ...
    log.info("MitsuCare API shutdown.")
...
app = FastAPI(
    title="MitsuCare — Predictive Maintenance API",
    description="AI-powered vehicle fault detection and owner alerts for Mitsubishi vehicles.",
    version="1.0.0",
    lifespan=lifespan,
)
